...
Gemeint ist hier der Abstand zwischen den eigenen [[Kreativität|kreativen]] *Ambitionen* und dem, was man tatsächlich *umgesetzt* bekommt (siehe: [[Effektivität]]). Besonders als Anfänger führt das zu enormen [[Motivation|Motivationsproblemen]], egal um welches Medium oder welche Disziplin es geht:
...
- Diesen gesamten Loop zu durchlaufen ist entsprechend wesentlich komplexer als etwa beim [[Kreatives Schreiben|Kreativen Schreiben]] – gerade deshalb muss man [[Perfektionismus]] vermeiden, um möglichst schnell mit allen Facetten der Spielentwicklung vertraut zu werden
